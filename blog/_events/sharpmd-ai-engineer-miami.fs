...
The expo floor was smaller than I imagined. I wore my **ER glasses** &mdash; Even Realities G2 units, and the reason they stood out is that the ecosystem running on them is open source and scrappy in the best way. My own tracking page for it ([vibe.shel.sh/db/even-realities-g2](https://vibe.shel.sh/db/even-realities-g2/)) lists the half-decent apps that survived contact with reality: **Tetris, Snake, Pong-vs-AI, and Arachnoid** &mdash; each with a global scoreboard, installed by scanning a QR code off a GitHub repo; **Books G2**, a Gutenberg library in your field of view; **Tesla vehicle controls**; a weather forecast; chess; a Home Assistant/HomeKit bridge; an ePub reader; Soniox speech-to-text memos; a Twitch chat HUD; a gym plan app. One of them, **Glint**, is an OpenClaw AI HUD.

Watching someone clear lines of Tetris on their face while walking the expo floor is a specific kind of future that feels closer than most futures. The better part was simply the live transcript that could translate right in my field of view. The privacy and locality of these open-source glasses really stood out to people. Not only was I an advocate for owning your own data, I was a CEO. The page footer for my site at the time says it flatly: *"Turtle Protect is a florida-based project. 🐢"* At the time of writing, that sentence was doing more brand work than any lanyard.
