module ConvertedFiles.AppsettingsJson
...
let file = """{
  ...
  "Netdocs": {
    "siteName": "Netdocs",
    "siteAuthor": "Netdocs contributors",
    "siteUrl": "https://net.shel.sh",
    "siteDescription": "A fast, flexible static site generator in .NET 11 — a Material for MkDocs derivative.",
    "copyright": "Netdocs — a derivative of MkDocs-Material (MIT).",
    "repoUrl": "https://github.com/CommanderTurtle/orc",
    "repoName": "CommanderTurtle/orc",
    "editUri": "edit/main/net/docs/",
    "docsDir": "docs",
    "siteDir": "site",
    ...
    "nav": [
      { "title": "Home", "path": "index.md", "icon": "home" },
      {
        ...
        "children": [
          ...
          { "path": "getting-started/authoring-environment.md" },
      ...
      },
      {
        ...
        "children": [
          ...
          { "path": "reference/page-metadata.md", "icon": "card-text-outline" },
          { "path": "reference/code-blocks.md", "icon": "code-braces" },
          { "path": "reference/grids.md", "icon": "grid" },
          ...
          { "path": "reference/admonitions-and-tabs.md", "icon": "alert" },
          {
            ...
            "children": [
              ...
              { "path": "plugins/macros.md" },
              { "path": "plugins/meta.md" },
              { "path": "plugins/redirects.md" },
              { "path": "plugins/rss.md" },
              { "path": "plugins/search.md" },
              { "path": "plugins/snippets.md" },
              { "path": "plugins/social.md" },
              { "path": "plugins/table-reader.md" },
              { "path": "plugins/tags.md" },
              { "path": "plugins/typeset.md" },
              { "path": "plugins/versioning.md" }
            ]
          }
        ]
      },
      ...
      },
      {
        ...
        "children": [
          ...
          { "path": "development/external-plugins.md" },
          { "path": "development/frontend-dependencies.md" },
          { "path": "development/versioning.md" }
        ]
      },
      {
        "title": "About",
    ...
    "extra": {
      "social": [
        { "icon": "fontawesome/brands/github", "link": "https://github.com/XtremeOwnage/Netdocs" }
      ]
    }
  }
}
