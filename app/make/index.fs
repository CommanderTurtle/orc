...
let page =
    html [ _lang "en" ] [
        head [] [
            ...
            script [ _type "module"; attr "crossorigin" ""; _src "/make/assets/index-Br0pSa9z.js" ] [ rawText ("""""") ]
            link [ attr "rel" "stylesheet"; attr "crossorigin" ""; _href "/make/assets/index-DHVnUZiV.css" ]
        ]
        body [] []
    ]
