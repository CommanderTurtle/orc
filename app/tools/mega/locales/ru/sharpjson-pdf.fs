module ConvertedFiles.Mega.Locales.Ru.PdfJson
...
let file = """{
  ...
  "rotatePdf": {
    ...
    "pagesWillBeRotated": "{{count}} страница будет вращаться",
    "pdfPageCount": "PDF имеет {{count}} страница",
  ...
  "splitPdf": {
    ...
    "inputTitle": "Входной PDF-файл",
    "pageExtractionPreview": "{{count}} страница будут извлечены",
    "pageRangesDescription": "Введите номера страниц или диапазоны, разделенные запятыми (например, 1,3,5-7)",
    "pageRangesPlaceholder": "например, 1,5-8",
