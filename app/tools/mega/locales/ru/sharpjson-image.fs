module ConvertedFiles.Mega.Locales.Ru.ImageJson

let file = """{
  "changeColors": {
    "description": "Быстро и точно заменяйте выбранные цвета на изображении новыми цветами.",
  ...
  "createTransparent": {
    "description": "Сделайте фон изображения прозрачным, удалив выбранный цвет.",
  ...
  "removeBackground": {
    "description": "Автоматически удалите фон изображения и сохраните основной объект на прозрачном фоне.",
  ...
  "split": {
    ...
    "loadingText": "Загрузка... Это может занять некоторое время.",
    "pageParameters": {
