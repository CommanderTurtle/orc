module ConvertedFiles.Mega.Locales.Ru.TranslationJson
...
let file = """{
  ...
  "hero": {
    ...
    "search": {
      "placeholder": "Поиск по всем инструментам",
      "noResult": "Результаты не найдены, попробуйте изменить параметры поиска или фильтрации"
    },
