module ConvertedFiles.Mega.Locales.Fr.TranslationJson
...
let file = """{
  ...
  "hero": {
    ...
    "search": {
      "placeholder": "Rechercher tous les outils",
      "noResult": "Aucun résultat trouvé, essayez d'ajuster votre recherche ou vos critères de filtre"
    },
