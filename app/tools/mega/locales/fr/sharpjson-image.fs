module ConvertedFiles.Mega.Locales.Fr.ImageJson

let file = """{
  "changeColors": {
    "description": "Remplace rapidement et precisement les couleurs selectionnees dans une image par de nouvelles couleurs.",
  ...
  "createTransparent": {
    "description": "Rends l'arriere-plan d'une image transparent en supprimant la couleur choisie.",
  ...
  "removeBackground": {
    "description": "Supprime automatiquement l'arriere-plan d'une image et conserve le sujet principal avec transparence.",
