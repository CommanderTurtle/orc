module ConvertedFiles.Mega.Locales.Fr.PdfJson
...
let file = """{
  ...
  "rotatePdf": {
    ...
    "pagesWillBeRotated": "{{count}} page{{plural}} sera tourné",
    "pdfPageCount": "PDF a {{count}} page{{plural}}",
  ...
  "splitPdf": {
    ...
    "inputTitle": "Entrée PDF",
    "pageExtractionPreview": "{{count}} page{{plural}} sera(ont) extrait(s)",
    "pageRangesDescription": "Saisissez les numéros de page ou les plages séparés par des virgules (par exemple, 1, 3, 5-7)",
    "pageRangesPlaceholder": "par exemple, 1,5-8",
