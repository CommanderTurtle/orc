module ConvertedFiles.Mega.Locales.En.VideoJson

let file = """{
  "addAudio": {
    "audioFile": "Audio File",
    "audioInputTitle": "Input Audio",
    "description": "Easily add an audio track to any video file. You can choose to replace the original audio entirely or mix a new track with the existing one. Adjust the volume, set looping options, and trim the audio with precise start and end times. Supports all common video and audio formats for flexible editing and quick results.",
    "durationMode": "Time Range",
    "endTime": "End Time",
    "endTimeDesc": "When the new audio stops playing (HH:MM:SS.mm).",
    "loadingText": "Adding audio to video...",
    "loop": "Loop (repeat audio until video end or defined end time)",
    "loopOption": "Loop options",
    "mode": "Audio Mode",
    "modeMix": "Mix (Keep Original + Add New)",
    "modeReplace": "Replace Original Audio",
    "noLoop": "No Loop (play audio only once)",
    "resultTitle": "Processed Video",
    "shortDescription": "Add or replace audio track in video",
    "startTime": "Start Time",
    "startTimeDesc": "When the new audio starts playing (HH:MM:SS.mm).",
    "timing": "Audio Timing",
    "timingDefault": "Default (full video)",
    "timingEnd": "Set End Time",
    "timingModeDesc": "Choose when the new audio plays within the video timeline.",
    "timingStart": "Set Start Time",
    "timingStartEnd": "Set Start & End Time",
    "title": "Add Audio to Video",
    "videoInputTitle": "Input Video",
    "volume": "New Audio Volume",
    "volumeDesc": "Volume level for the new audio track."
  },
  "changeSpeed": {
