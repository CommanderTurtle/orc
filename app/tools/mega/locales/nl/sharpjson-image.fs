module ConvertedFiles.Mega.Locales.Nl.ImageJson

let file = """{
  "changeColors": {
    "description": "Vervang geselecteerde kleuren in een afbeelding snel en nauwkeurig door nieuwe kleuren.",
  ...
  "createTransparent": {
    "description": "Maak de achtergrond van een afbeelding transparant door de gekozen kleur te verwijderen.",
  ...
  "removeBackground": {
    "description": "Verwijder automatisch de achtergrond van een afbeelding en behoud het hoofdonderwerp met transparantie.",
