module ConvertedFiles.Mega.Locales.Nl.PdfJson
...
let file = """{
  ...
  "rotatePdf": {
    ...
    "pagesWillBeRotated": "{{count}} pagina{{plural}} zal worden gedraaid",
    "pdfPageCount": "PDF heeft {{count}} pagina{{plural}}",
  ...
  "splitPdf": {
    ...
    "inputTitle": "PDF-invoer",
    "pageExtractionPreview": "{{count}} pagina{{ plural }} zal worden geëxtraheerd",
    "pageRangesDescription": "Voer paginanummers of bereiken in, gescheiden door komma's (bijv. 1, 3, 5-7)",
    "pageRangesPlaceholder": "bijv. 1,5-8",
