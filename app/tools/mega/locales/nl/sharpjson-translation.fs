module ConvertedFiles.Mega.Locales.Nl.TranslationJson
...
let file = """{
  ...
  "hero": {
    ...
    "search": {
      "placeholder": "Alle tools doorzoeken",
      "noResult": "Geen resultaten gevonden, probeer uw zoekopdracht of filtercriteria aan te passen"
    },
