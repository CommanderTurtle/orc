module ConvertedFiles.Mega.Locales.Pt.PdfJson
...
let file = """{
  ...
  "rotatePdf": {
    ...
    "pagesWillBeRotated": "{{count}} página{{plural}} será girado",
    "pdfPageCount": "PDF tem {{count}} página{{plural}}",
  ...
  "splitPdf": {
    ...
    "inputTitle": "PDF de entrada",
    "pageExtractionPreview": "{{count}} página{{ plural }} será extraído",
    "pageRangesDescription": "Insira números de página ou intervalos separados por vírgulas (por exemplo, 1,3,5-7)",
    "pageRangesPlaceholder": "por exemplo, 1,5-8",
