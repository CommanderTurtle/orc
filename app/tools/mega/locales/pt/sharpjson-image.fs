module ConvertedFiles.Mega.Locales.Pt.ImageJson

let file = """{
  "changeColors": {
    "description": "Substitua cores selecionadas em uma imagem por novas cores de forma rapida e precisa.",
  ...
  "createTransparent": {
    "description": "Torne o fundo de uma imagem transparente removendo a cor escolhida.",
  ...
  "removeBackground": {
    "description": "Remova automaticamente o fundo de uma imagem e mantenha o assunto principal com transparencia.",
