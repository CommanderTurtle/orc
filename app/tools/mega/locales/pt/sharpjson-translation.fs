module ConvertedFiles.Mega.Locales.Pt.TranslationJson
...
let file = """{
  ...
  "hero": {
    ...
    "search": {
      "placeholder": "Pesquisar todas as ferramentas",
      "noResult": "Nenhum resultado encontrado, tente ajustar a sua pesquisa ou os critérios de filtro"
    },
