module ConvertedFiles.Mega.Locales.Es.ImageJson

let file = """{
  "changeColors": {
    "description": "Reemplaza colores seleccionados en una imagen por nuevos colores de forma rapida y precisa.",
  ...
  "createTransparent": {
    "description": "Haz transparente el fondo de una imagen eliminando el color seleccionado.",
  ...
  "removeBackground": {
    "description": "Elimina automaticamente el fondo de una imagen y deja el sujeto principal listo con transparencia.",
