module ConvertedFiles.Mega.Locales.Es.PdfJson
...
let file = """{
  ...
  "rotatePdf": {
    ...
    "pagesWillBeRotated": "{{count}} página{{plural}} se rotará",
    "pdfPageCount": "PDF tiene {{count}} página{{plural}}",
  ...
  "splitPdf": {
    ...
    "inputTitle": "PDF de entrada",
    "pageExtractionPreview": "{{count}} página{{ plural }} se extraerán",
    "pageRangesDescription": "Introduzca números de página o rangos separados por comas (por ejemplo, 1, 3, 5-7)",
    "pageRangesPlaceholder": "p. ej., 1,5-8",
