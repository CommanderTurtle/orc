module ConvertedFiles.Mega.Locales.Hi.TimeJson
...
let file = """{
  ...
  "crontabGuru": {
    "title": "Crontab Guru",
    "description": "क्रॉन एक्सप्रेशन को हिंदी में पार्स और समझाएं। किसी भी क्रॉन शेड्यूल को तुरंत समझें, सिंटैक्स को वैलिडेट करें और एक साथ कई एक्सप्रेशन प्रोसेस करें।",
    "shortDescription": "क्रॉन एक्सप्रेशन को सरल भाषा में पार्स और समझाएं",
    "longDescription": "Crontab Guru एक क्रॉन एक्सप्रेशन पार्सर और वैलिडेटर है जो जटिल क्रॉन सिंटैक्स को स्पष्ट, पठनीय विवरणों में अनुवाद करता है। चाहे आप स्वचालित बैकअप, सिस्टम रखरखाव कार्य, या CI/CD पाइपलाइन शेड्यूल कर रहे हों, यह टूल आपको यह समझने में मदद करता है कि आपके जॉब्स ठीक कब चलेंगे। मानक 5-फील्ड क्रॉन एक्सप्रेशन का समर्थन करता है, रियल टाइम में सिंटैक्स वैलिडेट करता है और एक साथ कई एक्सप्रेशन प्रोसेस करता है — एक प्रति पंक्ति।"
  },
  "timeBetweenDates": {
