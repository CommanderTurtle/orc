module ConvertedFiles.Mega.Locales.Hi.PdfJson
...
let file = """{
  ...
  "rotatePdf": {
    ...
    "pagesWillBeRotated": "{{count}} पृष्ठ घुमाया जाएगा",
    "pdfPageCount": "पीडीएफ में है {{count}} पृष्ठ",
  ...
  "splitPdf": {
    ...
    "includeBookmarks": "बुकमार्क शामिल करें",
    "inputTitle": "इनपुट PDF",
    "pageExtractionPreview": "{{count}} पृष्ठ निकाला जाएगा",
