module ConvertedFiles.Mega.Locales.Hi.ImageJson

let file = """{
  "changeColors": {
    "description": "चित्र में चुने गए रंगों को जल्दी और सही तरीके से नए रंगों से बदलें।",
  ...
  "createTransparent": {
    "description": "चुने गए रंग को हटाकर चित्र की पृष्ठभूमि को पारदर्शी बनाएं।",
  ...
  "removeBackground": {
    "description": "चित्र की पृष्ठभूमि को अपने आप हटाएं और मुख्य विषय को पारदर्शी रूप में रखें।",
