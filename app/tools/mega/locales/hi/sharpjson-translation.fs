module ConvertedFiles.Mega.Locales.Hi.TranslationJson
...
let file = """{
  ...
  "hero": {
    ...
    "search": {
      "placeholder": "सभी टूल खोजें",
      "noResult": "कोई परिणाम नहीं मिला, अपनी खोज या फ़िल्टर मानदंड समायोजित करने का प्रयास करें"
    },
