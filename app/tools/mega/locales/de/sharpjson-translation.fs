module ConvertedFiles.Mega.Locales.De.TranslationJson
...
let file = """{
  ...
  "hero": {
    ...
    "search": {
      "placeholder": "Alle Tools durchsuchen",
      "noResult": "Keine Ergebnisse gefunden, versuchen Sie Ihre Suche oder Filterkriterien anzupassen"
    },
