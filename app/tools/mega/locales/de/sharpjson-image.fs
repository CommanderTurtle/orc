module ConvertedFiles.Mega.Locales.De.ImageJson

let file = """{
  "changeColors": {
    "description": "Ersetze ausgewahlte Farben in einem Bild schnell und prazise durch neue Farben.",
  ...
  "createTransparent": {
    "description": "Mache den Hintergrund eines Bildes transparent, indem du die ausgewahlte Farbe entfernst.",
  ...
  "removeBackground": {
    "description": "Entferne den Hintergrund eines Bildes automatisch und behalte das Hauptmotiv transparent bei.",
