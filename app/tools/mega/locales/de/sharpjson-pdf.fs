module ConvertedFiles.Mega.Locales.De.PdfJson
...
let file = """{
  ...
  "rotatePdf": {
    ...
    "pagesWillBeRotated": "{{count}} Seite{{plural}} wird gedreht",
    "pdfPageCount": "PDF hat {{count}} Seite{{plural}}",
  ...
  "splitPdf": {
    ...
    "inputTitle": "Eingabe-PDF",
    "pageExtractionPreview": "{{count}} Seite{{plural}} wird extrahiert",
    "pageRangesDescription": "Geben Sie Seitenzahlen oder Bereiche durch Kommas getrennt ein (z. B. 1,3,5-7).",
    "pageRangesPlaceholder": "z.B. 1,5-8",
