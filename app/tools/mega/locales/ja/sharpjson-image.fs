module ConvertedFiles.Mega.Locales.Ja.ImageJson

let file = """{
  "changeColors": {
    "description": "画像内の選択した色をすばやく正確に新しい色へ置き換えます。",
  ...
  "createTransparent": {
    "description": "選択した色を削除して、画像の背景を透明にします。",
  ...
  "removeBackground": {
    "description": "画像の背景を自動で削除し、主要な被写体を透過状態で残します。",
