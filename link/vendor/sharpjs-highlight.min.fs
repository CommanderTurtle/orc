...
begin:'"""
    """',end:'"""
    """',relevance:10},{begin:'"',end:'"'},{begin:"'",end:"'"}]
...
},e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE,{begin:/"""
    """/,end:/"""
    """/,
...
contains:[e.BACKSLASH_ESCAPE,r,o,s]},{begin:/([fFtT][rR]|[rR][fFtT]|[fFtT])"""
    ...
    """/,contains:[e.BACKSLASH_ESCAPE,r,o,s]},{begin:/([uU]|[rR])'/,end:/'/,
