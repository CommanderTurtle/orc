...
let page =
    html [ _lang "en" ] [
        head [] [
            ...
            title [] [
                str "Unauthorized Access - providers.shel.sh"
            ]
